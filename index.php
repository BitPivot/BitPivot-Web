	...
	<body>
		...
		<div class="background white">
			<div class="container">
				...
				<div class="row"><div class="span12">
					<header>
						<a class="brand" href="/"><i class="sprite" id="bitpivot-header-logo"></i></a>
						<span class="hidden-phone"><a href="http://www.twitter.com/BitPivot">Follow us on Twitter! <img src="img/icon-twitter.png"/></a></span>
						<span class="visible-phone"><a href="http://www.twitter.com/BitPivot"><img src="img/icon-twitter.png"/></a></span>
						<span class="hidden-phone"><a href="http://www.facebook.com/BitPivot">Like us on Facebook! <img src="img/icon-facebook.png"/></a></span>
						<span class="visible-phone"><a href="http://www.facebook.com/BitPivot"><img src="img/icon-facebook.png"/></a></span>
					</header>
				</div></div>
				...
				<section id="banner">
					<div class="row hidden-phone">
						<div class="span4 content">
							<div id="logo">
								<img class="hi" src="img/banner-logo-hi.png" alt="Hi"/>
								<img class="dark" src="img/banner-logo-dark.png" alt=""/>
								<img class="light" src="img/banner-logo-light.png" alt=""/>
								<img class="shadow" src="img/banner-logo-shadow.png" alt=""/>
								<img class="fallback" src="img/banner-logo-fallback.png" alt="Hi"/>
							</div>
						</div>
				...
				<!-- Navbar -->
				<div class="row hidden-phone"><div class="span12">
					<nav>
						<ul>
				...
				<section id="bio" class="content">
						...
						<article>
							<div class="span4">
								<figure class="thumbnail">
									<img src="img/photo-rob-hencke.jpg" alt="Rob Hencke"/>
									<figcaption>
										<div class="name">Rob Hencke</div>
										<div class="specialization">Systems Design and Development</div>
									</figcaption>
								</figure>
							</div>
					...
					<div class="row">
						...
						<article>
							<div class="span4">
								<figure class="thumbnail">
									<img src="img/photo-matthew-mcmillion.jpg" alt="Matthew McMillion"/>
									<figcaption>
										<div class="name">Matthew McMillion</div>
										<div class="specialization">Web and User Experience Development</div>
									</figcaption>
								</figure>
							</div>
					...
					<div class="row">
						...
						<article>
							<div class="span4">
								<figure class="thumbnail">
									<img src="img/photo-sean-kennedy.jpg" alt="Sean Kennedy"/>
									<figcaption>
										<div class="name">Sean Kennedy</div>
										<div class="specialization">Application Development and API Integration</div>
									</figcaption>
								</figure>
							</div>
		...
		<div class="background grey">
			<div class="container">
				...
				<section id="request" class="content">
		...
		<div class="background purple">
			<div class="container">
				...
				<div class="row"><div class="span12">
					<footer>
						<ul>
							<li>Copyright &copy; 2013 BitPivot, LLC</li>
